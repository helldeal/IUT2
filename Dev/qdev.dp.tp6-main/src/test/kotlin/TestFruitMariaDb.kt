...
class TestFruitMariaDb {
    ...
    @BeforeEach
    fun init() {
        TODO("configurer correctement")
        val host = "172.21.2.17" //"srv-infoweb.iut-nantes.univ-nantes.prive"
        val database = "TODO"
        val user = "TODO"
        val password = "TODO"
        dao = FruitMariaDbDAO(host, database, user, password)
        (dao as FruitMariaDbDAO).restaurationDatabase()
    }
